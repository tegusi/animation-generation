...
class DataHandler:
    ...
    def _load_data(self, config):
        ...
        fps = int(load_from_config(config, 'fps'))
        ...
        if os.path.exists(processed_audio_path):
            ...
            self.processed_audio =  self._process_audio(self.raw_audio, fps)
    ...
    def _process_audio(self, raw_audio, fps):
        return self.audio_handler.process(raw_audio, fps)