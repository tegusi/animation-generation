...
parser.add_argument('--tf_model_fname', default='./checkpoint_xwlb/checkpoints/gstep_32190.model', help='Path to trained VOCA model')
parser.add_argument('--ds_fname', default='./ds_graph/output_graph.pb', help='Path to trained DeepSpeech model')
parser.add_argument('--audio_fname', default='./audio/ouyang00.wav', help='Path of input speech sequence')
parser.add_argument('--template_fname', default='./template/Ouyang.ply', help='Path of "zero pose" template mesh in" FLAME topology to be animated')
parser.add_argument('--condition_idx', type=int, default=1, help='Subject condition id in [1,8]')
